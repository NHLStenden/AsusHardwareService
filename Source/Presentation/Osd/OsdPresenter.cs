...
internal static class OsdPresenter
{
    ...
    internal static void ShowStatusWindow(IntPtr window)
    {
        ...
        SetStatusWindowPosition(window, _finalY, show: alreadyVisible || !OsdTheme.AnimationsEnabled);
        UpdateWindow(window);
    ...
    {
        var translation = Scale(EntranceTranslationDip, OsdHost.WindowDpi);
        var direction = OsdTheme.IndicatorPosition == IndicatorPosition.BottomCenter ? 1 : -1;
